...
public class MenuScreen implements Screen {
    ...
    public void createGUI() {
        ...
        btnNewGame.setPosition(395, 300);
        ...
        Button btnMapEditor = new TextButton("Map Editor", skin, "simpleSkin");
        btnMapEditor.setPosition(395, 150);
        stage.addActor(btnMapEditor);
        btnMapEditor.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                ScreenManager.getInstance().changeScreen(ScreenManager.ScreenType.MAP_EDITOR);
            }
        });
    }
